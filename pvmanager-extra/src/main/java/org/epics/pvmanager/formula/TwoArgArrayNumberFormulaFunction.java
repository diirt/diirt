 ...
 * 
 */
public abstract class TwoArgArrayNumberFormulaFunction implements
	FormulaFunction {
    ...
    public TwoArgArrayNumberFormulaFunction(String name, String description,
	...
	return newVNumberArray(
		calculate(((VNumberArray) args.get(0)).getData(),
			((VNumber) args.get(1)).getValue()), alarmNone(),
		timeNow(), displayNone());
