...
//    @Test
    public void exportVNumber1() {
        VNumber value = VDouble.of(1.0, Alarm.none(), Time.of(Instant.ofEpochSecond(0, 0)), Display.none());
        CSVIO io = new CSVIO();
...
//    @Test
    public void exportVNumber2() {
        VNumber value = VInt.of(10, Alarm.none(), Time.of(Instant.ofEpochSecond(90, 0)), Display.none());
        CSVIO io = new CSVIO();
...
//    @Test
    public void exportVString1() {
        VString value = VString.of("Hello world!", Alarm.none(), Time.of(Instant.ofEpochSecond(133, 0)));
        CSVIO io = new CSVIO();
...
//    @Test
    public void exportVStringArray1() {
        VStringArray value = VStringArray.of(Arrays.asList("The first", "The second"), Alarm.none(), Time.of(Instant.ofEpochSecond(133, 0)));
        CSVIO io = new CSVIO();
...
//    @Test
    public void exportVEnum1() {
        VEnum value = VEnum.of(1, EnumDisplay.of(Arrays.asList("One", "Two", "Three")), Alarm.none(), Time.of(Instant.ofEpochSecond(133, 0)));
        CSVIO io = new CSVIO();
...
//        VEnumArray value = newVEnumArray(new ArrayInt(1,0,0,2), Arrays.asList("One", "Two", "Three"), Alarm.none(), Time.of(Instant.ofEpochSecond(133, 0)));
//        CSVIO io = new CSVIO();
...
//    }
    ...
    public void exportVTable() {
        VTable value = VTable.of(Arrays.<Class<?>>asList(String.class, Double.TYPE, Integer.TYPE),
                                   Arrays.asList("Name", "Value", "Index"),
                                   Arrays.<Object>asList(Arrays.asList("A", "B", "C", "D", "E"),
                                          ArrayDouble.of(0.234, 1.456, 234567891234.0, 0.000000123, 123),
                                          ArrayInteger.of(1,2,3,4,5)));
        CSVIO io = new CSVIO();
        exportTest(io, value, "NONE None" + "\"Name\" \"Value\" \"Index\"\n" +
                "\"A\" 0.234 1\n" +
                "\"B\" 1.456 2\n" +
    ...
    public void exportVTable2() {
        VTable value = VTable.of(Arrays.<Class<?>>asList(String.class, Double.TYPE, Integer.TYPE, Instant.class),
        ...
        CSVIO io = new CSVIO();
        exportTest(io, value, "NONE None" + "\"Name\" \"Value\" \"Index\" \"Time\"\n" +
    ...
    public void importVTable1() {
        ...
        assertThat(value.getColumnData(1), equalTo((Object) ArrayDouble.of(0.234, 1.456, 234567891234.0, 0.000000123, 123)));
        assertThat(value.getColumnData(2), equalTo((Object) ArrayDouble.of(1,2,3,4,5)));
    }
