...
public class VColumn {
    ...
    public static Object combineData(Class<?> type, int size, ListInteger offsets, List<VColumn> columns) {
    ...
    private static Object combineStringData(final int size, final ListInteger offsets, final List<VColumn> columns) {
    ...
    private static Object combineDoubleData(final int size, final ListInteger offsets, final List<VColumn> columns) {
