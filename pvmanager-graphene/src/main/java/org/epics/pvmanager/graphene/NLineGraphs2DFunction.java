 ...
 * @author carcassi
 */
class NLineGraphs2DFunction implements ReadFunction<Graph2DResult> {
    ...
    private NLineGraphs2DRenderer renderer = new NLineGraphs2DRenderer(300, 200);
    
    private VImage previousImage;
    private final QueueCollector<NLineGraphs2DRendererUpdate> rendererUpdateQueue = new QueueCollector<>(100);

    NLineGraphs2DFunction(ReadFunction<?> tableData,
    ...
    public QueueCollector<NLineGraphs2DRendererUpdate> getRendererUpdateQueue() {
    ...
    public Graph2DResult readValue() {
        ...
        List<NLineGraphs2DRendererUpdate> updates = rendererUpdateQueue.readValue();
        for (NLineGraphs2DRendererUpdate rendererUpdate : updates) {
