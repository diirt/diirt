...
public class LineGraphRenderer {
    ...
    public void draw(Graphics2D g, Point2DDataset data) {
        ...
        integratedMinX = java.lang.Double.isNaN(data.getXStatistics().getMinimum().doubleValue()) ? integratedMinX : Math.min(integratedMinX, data.getXStatistics().getMinimum().doubleValue());
        integratedMinY = java.lang.Double.isNaN(data.getYStatistics().getMinimum().doubleValue()) ? integratedMinY : Math.min(integratedMinY, data.getYStatistics().getMinimum().doubleValue());
        integratedMaxX = java.lang.Double.isNaN(data.getXStatistics().getMaximum().doubleValue()) ? integratedMaxX : Math.max(integratedMaxX, data.getXStatistics().getMaximum().doubleValue());
        integratedMaxY = java.lang.Double.isNaN(data.getYStatistics().getMaximum().doubleValue()) ? integratedMaxY : Math.max(integratedMaxY, data.getYStatistics().getMaximum().doubleValue());
