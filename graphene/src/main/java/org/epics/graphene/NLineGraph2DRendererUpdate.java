 ...
 * @author smaceul
 */
public class NLineGraph2DRendererUpdate extends Graph2DRendererUpdate<NLineGraph2DRendererUpdate>{
     ...
     * @return this
     */
    public NLineGraph2DRendererUpdate interpolation(InterpolationScheme scheme) {
        if (scheme == null) {
     ...
     * @return this
     */
    public NLineGraph2DRendererUpdate dataReduction(ReductionScheme scheme) {
        if (scheme == null) {
     ...
     * @return this
     */
    public NLineGraph2DRendererUpdate highlightFocusValue(boolean highlightFocusValue) {
