 ...
 * @author carcassi
 */
public class NLineGraphsDialog extends javax.swing.JDialog {

    private final NLineGraphsApp graph;
    
    /**
     * Creates new form ScatterGraphDialog
     */
    public NLineGraphsDialog(java.awt.Frame parent, boolean modal, NLineGraphsApp graph) {
        super(parent, modal);
        this.graph = graph;
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NLineGraphsDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                NLineGraphsDialog dialog = new NLineGraphsDialog(new javax.swing.JFrame(), true, null);
