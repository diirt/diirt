        ...
        if (channelname != null && channelname.trim().length > 0) {
            ...
            channel.addCallback(function(evt, channel) {
                            ...
                            case "value": //value changed
								...
								gauges[channel.getId()].Set ('chart.colors.ranges', [[channelValue.display.lowDisplay, channelValue.display.lowAlarm, 'red'],
								[channelValue.display.lowAlarm, channelValue.display.lowWarning, 'yellow'], [channelValue.display.highWarning, channelValue.display.highAlarm, 'yellow'], [channelValue.display.highAlarm, channelValue.display.highDisplay, 'red']]);
