 ...
 */
package org.diirt.service.pva.rpcservice.rpcclient;
...
public interface PoolStatistics {
  ...
  /**
   * Returns true if {@link org.diirt.service.pva.rpcservice.rpcclient.RPCClientPool#close close} has been called,
