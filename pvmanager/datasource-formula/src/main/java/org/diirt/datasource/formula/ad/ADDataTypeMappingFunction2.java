...
public class ADDataTypeMappingFunction2 implements FormulaFunction {
    ...
    public List<Class<?>> getArgumentTypes() {
        return Arrays.asList(VNumberArray.class, VString.class);
    }
    ...
    public Object calculate(List<Object> args) {
        ...
        VString dataType = (VString) args.get(1);
