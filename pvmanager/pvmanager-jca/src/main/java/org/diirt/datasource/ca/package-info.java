 ...
 * <p>
 * The {@link org.diirt.datasource.ca.JCADataSource} uses the {@link org.diirt.datasource.MultiplexedChannelHandler}. The
 * connection payload used is the JCA Channel class directly. The payload for
 * each monitor event is the {@link org.diirt.datasource.ca.JCAMessagePayload}, which includes both
 ...
 * through the {@link org.diirt.datasource.ca.JCATypeAdapter}. A JCATypeSupport can be passed
