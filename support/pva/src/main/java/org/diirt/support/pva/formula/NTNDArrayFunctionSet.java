...
import org.diirt.support.pva.PVANTNDArray;
...
public class NTNDArrayFunctionSet extends FormulaFunctionSet {
    ...
    public NTNDArrayFunctionSet() {
        super(new FormulaFunctionSetDescription("NTNDArray", "NTNDArray related functions")
    ...
    static class NTNDArrayAttributesFormulaFunction implements FormulaFunction {
        ...
        static final Class<?>[] COLUMN_TYPES = new Class<?>[] { String.class, String.class, String.class, int.class,
                String.class };
                ...
                if (columnType.equals(String.class)) {
                    ...
                    if (index == 1) {
                        ...
                        for (int i = 0; i < rows; i++) {
                            ...
                            columnData.add(pvData != null ? pvData.toString() : null);
                        }

                    } else {
                        for (int i = 0; i < rows; i++)
                            columnData.add(attributeArrayData.data[i].getStringField(COLUMN_NAMES[index]).get());
                    }
                    ...
                    columnValues.add(ArrayInteger.of(columnData));
                } else
                    throw new RuntimeException("unsupported attribute field type");
            }

            return VTable.of(Arrays.asList(COLUMN_TYPES), Arrays.asList(COLUMN_NAMES), columnValues);
        }
    ...
    static class NTNDArrayNDArrayFormulaFunction implements FormulaFunction {
        ...
        public Object calculate(List<Object> args) {
            ...
            return VNumberArray.of(data, ArrayInteger.of(sizes), alarmOf(pvStructure, false), timeOf(pvStructure),
                    displayOf(pvStructure));
        }
    ...
    public static VImage createVImage(PVScalarArray valueArray, NDColorMode mode, int[] dims) {
        ...
        case NDColorModeBayer: {
            ...
            case pvBoolean: {
                ...
                return VImage.of(height, width, CollectionNumbers.toListByte(data), VImageDataType.pvBoolean, VImageType.TYPE_BAYER, Alarm.none(), Time.now());
            }
            ...
            case pvUByte: {
                ...
                return VImage.of(height, width, CollectionNumbers.toListByte(data), VImageDataType.pvByte, VImageType.TYPE_BAYER, Alarm.none(), Time.now());
            }
            ...
            case pvUShort: {
                ...
                return VImage.of(height, width, CollectionNumbers.toListByte(data), VImageDataType.pvShort, VImageType.TYPE_BAYER, Alarm.none(), Time.now());
            }
            ...
            case pvUInt: {
                ...
                return VImage.of(height, width, CollectionNumbers.toListByte(data), VImageDataType.pvInt, VImageType.TYPE_BAYER, Alarm.none(), Time.now());
            }
            ...
            case pvULong: {
                ...
                return VImage.of(height, width, CollectionNumbers.toListByte(data), VImageDataType.pvLong, VImageType.TYPE_BAYER, Alarm.none(), Time.now());
            }
            ...
            case pvFloat: {
                ...
                return VImage.of(height, width, CollectionNumbers.toListByte(data), VImageDataType.pvFloat, VImageType.TYPE_BAYER, Alarm.none(), Time.now());
            }
            ...
            case pvDouble: {
                ...
                return VImage.of(height, width, CollectionNumbers.toListByte(data), VImageDataType.pvDouble, VImageType.TYPE_BAYER, Alarm.none(), Time.now());
            }
        ...
        case NDColorModeRGB1: {
            ...
            return VImage.of(height, width, CollectionNumbers.toListByte(data), VImageDataType.pvDouble, VImageType.TYPE_RGB1, Alarm.none(), Time.now());
        }
        ...
        case NDColorModeRGB2: {
            ...
            return VImage.of(height, width, CollectionNumbers.toListByte(data), VImageDataType.pvDouble, VImageType.TYPE_RGB2, Alarm.none(), Time.now());
        }
        ...
        case NDColorModeRGB3: {
            ...
            return VImage.of(height, width, CollectionNumbers.toListByte(data), VImageDataType.pvDouble, VImageType.TYPE_RGB3, Alarm.none(), Time.now());
        }
