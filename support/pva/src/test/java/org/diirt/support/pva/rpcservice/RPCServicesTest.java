...
import org.diirt.support.pva.rpcservice.PVARPCServiceProvider;
import java.io.*;
...
public class RPCServicesTest implements Runnable {
  ...
  public void testNullInputStream() throws Exception {
    RPCService service = RPCServices.createFromXml(null);
  }
  ...
  public void testCreateFromXml() {
    ...
    assertThat(service.getRPCServiceDescription().getRPCServiceMethodDescriptions().get("sum").getStructureId(),
...
*/
  ...
  public void testMethodWithOperationName() {
    ...
    //checking the specifics of pva rpc
    assertThat(service.getRPCServiceDescription().getRPCServiceMethodDescriptions().get("sumFloat").getOperationName(),
      equalTo("sumFoo"));
  }
